 ...
 * @author mauro
 */
public class VentanaReporteClienteNombre extends javax.swing.JDialog {


    public VentanaReporteClienteNombre(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        buscarPorNombre("");
    }
    ...
    private void buscarPorNombre(String nombre) {
        ...
        try {
            for (Cliente c : ClienteCrud.buscarPorNombre(nombre)) {
                Object[] fila = {
                    c.getDni(),
                    c.getNombre(),
                    c.getDireccion(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaReporteClienteNombre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaReporteClienteNombre dialog = new VentanaReporteClienteNombre(new javax.swing.JFrame(), true);
