 ...
 * @author mauro
 */
public class VentanaReporteHotelCategoria extends javax.swing.JDialog {

    /**
     * Creates new form VentanaReporteHotelNombre
     */
    public VentanaReporteHotelCategoria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        buscarPorCategoria("");
    }
    ...
    private void buscarPorCategoria(String categoria) {
        ...
        try {
            for (Hotel h : HotelCrud.buscarPorNombre(categoria)) {
                Object[] fila = {
                    h.getCodigo(),
                    h.getNombre(),
                    h.getDireccion(),
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 25, -1, -1));
    ...
    private void jTBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTBuscarKeyReleased
        buscarPorCategoria(jTBuscar.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaReporteHotelCategoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaReporteHotelCategoria dialog = new VentanaReporteHotelCategoria(new javax.swing.JFrame(), true);
