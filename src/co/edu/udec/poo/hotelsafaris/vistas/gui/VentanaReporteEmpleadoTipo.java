 ...
 * @author mauro
 */
public class VentanaReporteEmpleadoTipo extends javax.swing.JDialog {


    public VentanaReporteEmpleadoTipo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        buscarPorTipo("");
    }
    ...
    private void buscarPorTipo(String tipo) {
        ...
        try {
            for (Empleado e : EmpleadoCrud.buscarPorTipo(tipo)) {
                Object[] fila = {
                    e.getDni(),
                    e.getNombre(),
                    e.getDireccion(),
    ...
    private void jTBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTBuscarKeyReleased
        buscarPorTipo(jTBuscar.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaReporteEmpleadoTipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaReporteEmpleadoTipo dialog = new VentanaReporteEmpleadoTipo(new javax.swing.JFrame(), true);
