...
public class VentanaCrudHotel extends javax.swing.JDialog {
    ...
    private void jBAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAgregarActionPerformed
        ...
        // Validaciones
        if (strCodigo.isEmpty() || nombre.isEmpty() || direccion.isEmpty() || telefono.isEmpty() || director == null) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "El código debe ser un número entero.", "Formato inválido", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void cargarDirectores() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al cargar directores: " + ex.getMessage());
        }
    }
